...
<div id="listaEntradas">
    <?php
        ...
        $checkingEntr = "select * from entradas Limit 3";
...
<div id="verEntradas">
    <form method="post" action="indexUser.php">
        <button class="btn btn-outline-success my-2 my-sm-0 botones" type="submit" name="verEntradas">Ver todas las entradas</button>
    </form>
</div>